...
import (
    ...
    // Local packages
    "api/internal/core/credentials/domain"
...
```go
// Good
credentialsApplication "api/internal/core/credentials/application"
credentialsDomain "api/internal/core/credentials/domain"
userApplication "api/internal/core/user/application"

// Bad — abbreviated feature names
credsApplication "api/internal/core/credentials/application"
credsDomain "api/internal/core/credentials/domain"
```
...
Keep consistent casing: `URL`, `ID`, `HTTP`, `SQL`, `API`.
...
- Do not capitalize (unless starting with a proper noun or exported name)
...
- Reserve panics for programmer errors (API misuse)
